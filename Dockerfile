...
RUN curl -kL https://developer.nvidia.com/compute/cuda/9.2/Prod2/local_installers2/cuda_9.2.148_win10 --output "C:\Temp\cuda_9.2.148_win10.exe" && `
    curl -kL https://downloads.sourceforge.net/project/cuda-dnn/7/CUDA-9.2/cudnn-9.2-windows10-x64-v7.2.1.38.zip --output "C:\Temp\cudnn-9.2-windows10-x64-v7.2.1.38.zip" && `
    7z x C:\Temp\cuda_9.2.148_win10.exe -o"C:\Temp\cuda92" && `
    del C:\Temp\cuda_9.2.148_win10.exe && `
    pushd C:\Temp\cuda92 && `
    ...
    xcopy /Y "C:\Temp\cuda92\CUDAVisualStudioIntegration\extras\visual_studio_integration\MSBuildExtensions\*.*" "C:\Program Files (x86)\Microsoft Visual Studio\2017\BuildTools\Common7\IDE\VC\VCTargets\BuildCustomizations" && `
    popd && `
    rd /s /q C:\Temp\cuda92 && `
    7z x C:\Temp\cudnn-9.2-windows10-x64-v7.2.1.38.zip -o"C:\Temp\cudnn92" && `
    del C:\Temp\cudnn-9.2-windows10-x64-v7.2.1.38.zip && `
    xcopy /Y "C:\Temp\cudnn92\cuda\bin\*.*" "%ProgramFiles%\NVIDIA GPU Computing Toolkit\CUDA\v9.2\bin" && `
    xcopy /Y "C:\Temp\cudnn92\cuda\lib\x64\*.*" "%ProgramFiles%\NVIDIA GPU Computing Toolkit\CUDA\v9.2\lib\x64" && `
    xcopy /Y "C:\Temp\cudnn92\cuda\include\*.*" "%ProgramFiles%\NVIDIA GPU Computing Toolkit\CUDA\v9.2\include" && `
    ...
    rd /s /q C:\Temp\cudnn92 && `
    curl -kL https://developer.nvidia.com/compute/cuda/10.0/Prod/local_installers/cuda_10.0.130_411.31_win10 --output "C:\Temp\cuda_10.0.130_411.31_win10.exe" && `
    curl -kL https://www.dropbox.com/s/9v1z9rmbjw9mhx2/cudnn-10.0-windows10-x64-v7.4.1.5.zip?dl=1 --output "C:\Temp\cudnn-10.0-windows10-x64-v7.4.1.5.zip" && `
    7z x C:\Temp\cuda_10.0.130_411.31_win10.exe -o"C:\Temp\cuda100" && `
    del C:\Temp\cuda_10.0.130_411.31_win10.exe && `
    pushd C:\Temp\cuda100 && `
    ...
    xcopy /Y "C:\Temp\cuda100\CUDAVisualStudioIntegration\extras\visual_studio_integration\MSBuildExtensions\*.*" "C:\Program Files (x86)\Microsoft Visual Studio\2017\BuildTools\Common7\IDE\VC\VCTargets\BuildCustomizations" && `
    popd && `
    rd /s /q C:\Temp\cuda100 && `
    7z x C:\Temp\cudnn-10.0-windows10-x64-v7.4.1.5.zip -o"C:\Temp\cudnn100" && `
    del C:\Temp\cudnn-10.0-windows10-x64-v7.4.1.5.zip && `
    xcopy /Y "C:\Temp\cudnn100\cuda\bin\*.*" "%ProgramFiles%\NVIDIA GPU Computing Toolkit\CUDA\v10.0\bin" && `
    xcopy /Y "C:\Temp\cudnn100\cuda\lib\x64\*.*" "%ProgramFiles%\NVIDIA GPU Computing Toolkit\CUDA\v10.0\lib\x64" && `
    xcopy /Y "C:\Temp\cudnn100\cuda\include\*.*" "%ProgramFiles%\NVIDIA GPU Computing Toolkit\CUDA\v10.0\include" && `
    ...
    rd /s /q C:\Temp\cudnn100 && `
    curl -kL https://www.dropbox.com/s/9mcolalfdj4n979/NvToolsExt.7z?dl=1 --output "C:\Temp\NvToolsExt.7z" && `
    7z x %SRC_DIR%\temp_build\NvToolsExt.7z -o"C:\Temp\NvToolsExt" && `
    del C:\Temp\NvToolsExt.7z && `
